        ...
        <div class="p-4 space-y-6">
          <div class="flex flex-col space-y-2">
            ...
            <div class="bg-neutral-700 w-full p-1 rounded-lg">
              <div class="bg-neutral-800 w-full p-1.5 flex items-center justify-between rounded-md">
          ...
          <div class="space-y-2">
            ...
            <div v-for="i in 3" :key="i" class="bg-neutral-700 w-full p-1 rounded-lg">
              <div class="bg-neutral-800 w-full px-2 flex items-center justify-between rounded-md">
...
<script setup lang="ts">
  ...
  function copySnippetURL(version: string | number) {
