          ...
          <UPageCard class="w-full min-w-md max-w-md rounded-lg">
            ...
            >
              <template #description>
                Already have an account? <ULink to="/auth/signin" class="text-primary font-medium">Sign in</ULink>
              </template>

              <template #footer>
                <div class="flex flex-col items-center text-xs space-y-4">
                  <p class="w-80 text-center">By proceeding you acknowledge that you have read, understood and agree to our <ULink to="https://loglybase.com/privacy" external>Privacy Policy</ULink> and <ULink to="https://loglybase.com/terms" external>Terms and Conditions</ULink>.</p>
